...
export default function SnackLog({dataEmPortugues, text, icon, end=false}:SnackLogProps){
    const formatedDate = formatDate(dataEmPortugues,"dd/MM/yyyy");
    const border = end?"":"border-b pb-4 border-neutral-700";
    return(
        <TouchableOpacity className={"flex justify-between items-center flex-row w-full mb-4 "+border}>
